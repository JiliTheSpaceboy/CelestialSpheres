...
public class ModBlocks {
    public static final Block ANORTHOSITE = registerBlock("anorthosite",
        new Block(FabricBlockSettings.of(Material.STONE, MapColor.LIGHT_GRAY).hardness(1.5f).resistance((6.0f)).requiresTool()),
    ...
    public static final Block ANORTHOSITE_IRON_ORE = registerBlock("anorthosite_iron_ore",
        new Block(FabricBlockSettings.of(Material.STONE, MapColor.LIGHT_GRAY).strength(3.0f).requiresTool()),
        ModItemGroup.CELESTIA_GENERIC_BLOCKS);
    ...
    public static final Block LIGHT_LUNAR_REGOLITH = registerBlock("light_lunar_regolith",
        new GravelBlock(FabricBlockSettings.of(Material.AGGREGATE, MapColor.STONE_GRAY).sounds(BlockSoundGroup.GRAVEL).strength(0.6f)),
        ModItemGroup.CELESTIA_MOON);
    ...
    public static final Block LIGHT_LUNAR_BRECCIA = registerBlock("light_lunar_breccia",
        new Block(FabricBlockSettings.of(Material.STONE, MapColor.STONE_GRAY).sounds(BlockSoundGroup.BASALT).strength(0.8f).requiresTool()),
        ModItemGroup.CELESTIA_MOON);
    ...
    public static final Block LIGHT_LUNARCRETE = registerBlock("light_lunarcrete",
        new Block(FabricBlockSettings.of(Material.STONE, MapColor.STONE_GRAY).strength(1.8f).requiresTool()),
        ModItemGroup.CELESTIA_MOON);
